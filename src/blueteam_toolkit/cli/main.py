...
from blueteam_toolkit.malware.framework import analyze_sample
...
def malware_analyze(
    ...
    report_base_name: str = "malware_analysis",
) -> None:
    print(analyze_sample(sample_path, sandbox_report, report_base_name))
